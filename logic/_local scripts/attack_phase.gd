...
## player and pass it to the battle phase.
## Filename: attack_phase.gd
...
func enter() -> void:
	...
	ManagerSignalBus.enable_attack_phase_hud_request.emit()
...
func exit() -> void:
	...
	ManagerSignalBus.disable_attack_phase_hud_request.emit()
